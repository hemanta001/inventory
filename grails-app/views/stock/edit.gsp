...
<div class="col-md-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2>Unit <small>edit</small><small><g:link action="create" controller="unit"  class="btn btn-success btn-xs">Add</g:link></small><small><g:link action="list" controller="unit"  class="btn btn-success btn-xs">List</g:link></small></h2>
        ...
        <div class="x_content">
            <br />
            <g:form action="save" controller="unit" class="form-horizontal form-label-left">
