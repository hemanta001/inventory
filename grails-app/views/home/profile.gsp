            ...
            <form class="form-horizontal form-label-left">
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <g:textField name="firstName" class="form-control" value="${userInstance?.firstName}" disabled="disabled"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Last Name</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <g:textField name="lastName" class="form-control" value="${userInstance?.lastName}" disabled="disabled"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <g:textField name="contactNumber" class="form-control" value="${userInstance?.contactNumber}" disabled="disabled"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <g:select name="role" from="${['admin': 'admin', 'member': 'member']}" optionKey="key" optionValue="value"  class="form-control" value="${userInstance?.role}" disabled="disabled"/>
                    </div>
                </div>
