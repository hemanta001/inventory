...
<div class="col-md-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2>Item <small>edit</small><small><g:link action="create" controller="item"  class="btn btn-success btn-xs">Add</g:link></small><small><g:link action="list" controller="item"  class="btn btn-success btn-xs">List</g:link></small></h2>
