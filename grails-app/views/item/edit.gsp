...
<div class="col-md-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2>Item edit<g:link action="create" controller="item"  class="btn btn-success btn-xs">Add</g:link><g:link action="list" controller="item"  class="btn btn-success btn-xs">List</g:link></h2>
