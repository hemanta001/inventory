...
<div class="col-md-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2>User create<g:link action="list" controller="user" class="btn btn-success btn-xs">List</g:link></h2>
        ...
        <div class="x_content">
            ...
            <form action="/user/save" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data" id="user_form">
                ...
                <g:render template="form2"></g:render>
                            ...
                            fields: {
                                ...
                                email: {
                                    validators: {
                                        ...
                                        emailAddress: {
                                            message: 'Please supply a valid email address.For eg:rajesh@gmail.com,yogesh@yahoo.com etc'

                                        },
                                        remote: {
                                            url: "${createLink(controller:'user', action:'checkEmail')}",
                                ...
                                userName: {
                                    validators: {
                                        ...
                                        remote: {
                                            url: "${createLink(controller:'user', action:'checkUserName')}",
                                            // Send { username: 'its value', email: 'its value' } to the back-end
                                            data: function (validator, $field, value) {
                                                return {
